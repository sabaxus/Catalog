...
<div class="container">
	...
	<form:form class="form-horizontal" method="post" modelAttribute="newuserForm" action="savenewuser.htm">
			...
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:textarea path="userAddress" rows="5" class="form-control" id="userAddress" placeholder="address" />
			...
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="userPhone" class="form-control" id="userPhone" placeholder="phone" />
			...
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="userEmail" class="form-control" id="userEmail" placeholder="email" />
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn-lg btn-primary pull-right"  id="myBtn" value="Admit form" >Admit form</button>
			</div>
		</div>
	</form:form>
