...
<html lang="en">
<head>
<title>List of smartphones</title>
		...
		<div class="main">
			...
			<c:forEach var="phone" items="${model.phoneList}"
				...
				<div class="col-sm-3">
					...
					<div class="price">
						Pret: <span class="Price-int"><c:out value="${phone.pret}" /></span>
				...
				<div class="col-sm-9">
					...
					<div class="Produs-listCenterColumn">
						<h3 class="Produs-nameHeading">
							<c:out value="${phone.specificatii}" />
						</h3>
						...
						<sec:authorize access="hasRole('USER')">
							<a
								href='${pageContext.request.contextPath}/smartphones/phone.htm?phoneId=<c:out value="${phone.id}"/>'><button
									type="button" class="btn btn-info">Details</button></a>
							<br />
							<br />
						</sec:authorize>
						<sec:authorize access="hasRole('ADMIN')">
							<a
								href='${pageContext.request.contextPath}/smartphones/edit.htm?phoneId=<c:out value="${phone.id}"/>'><button
									type="button" class="btn btn-warning">Edit</button></a>
						</sec:authorize>
						<br /> <br />
						<sec:authorize access="hasRole('ADMIN')">
							<a
								href='${pageContext.request.contextPath}/smartphones/sterge/<c:out value="${phone.id}"/>'><button
			...
			<a href='${pageContext.request.contextPath}/smartphones/newlist.htm'><button
					type="button" class="btn-info">Filter again the smartphone
					list</button></a><br /> <br />

			<sec:authorize access="hasRole('ADMIN')">
				<div class="newphone">
					<a href='${pageContext.request.contextPath}/smartphones/new.htm'><button
							type="button" class="btn-success">Add new smartphone</button></a><br />
					<br />
				</div>
			</sec:authorize>
