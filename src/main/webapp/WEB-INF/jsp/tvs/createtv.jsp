...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/core/css/laptop.css" />" global media="all" />
<style>
.Tabs-content {
	padding: 80px 120px;
}
...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="title" align="center">
		<h2>Insert new tv data</h2>
	</div>

	<form:form action="savenew.htm" method="post" commandName="newtvForm">
