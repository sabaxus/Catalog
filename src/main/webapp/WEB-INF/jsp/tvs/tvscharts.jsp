...
<script type="text/javascript">
  window.onload = function () {
    ...
    var chart1 = new CanvasJS.Chart("chartContainer1",
    	    {
    	      ...
    	      data: [
    	      {
    	       ...
    	       dataPoints: [
    	    	   ...
    	    	   {  y: ${type.value}, legendText:"${type.key} ${100*(type.value)}%", indexLabel: "${type.key} ${100*(type.value)}%" },
    	    	   </c:forEach>
    	       ]
    	    	     }
    	    	     ]
	...
	{
	  title:{
	    text: "Tvs Screen Types percentages",
	    fontFamily: "Impact",
	    fontWeight: "normal"
	  },
	  ...
	  data: [
	  {
	   ...
	   showInLegend: true,
	   dataPoints: [
	       <c:forEach var="screenType" items="${screenTypeMap}">
	       {  y: ${screenType.value}, legendText:"${screenType.key} ${100*(screenType.value)}%", indexLabel: "${screenType.key} ${100*(screenType.value)}%" },
	       </c:forEach>
	  ]
	 }
	 ]
	...
	chart2.render();
    		...
    		var chart3 = new CanvasJS.Chart("chartContainer3",
    	    		{
    	    		  title:{
    	    		    text: "Tvs Screen Dimensions percentages",
    	    		    fontFamily: "Impact",
    	    		    fontWeight: "normal"
    	    		  },
    	    		...
    	    		var chart4 = new CanvasJS.Chart("chartContainer4",
    	    	    		{
    	    	    		  title:{
    	    	    		    text: "Tvs Operating Systems percentages",
    	    	    		    fontFamily: "Impact",
    	    	    		    fontWeight: "normal"
    	    	    		  },
    	    	    		  ...
    	    	    		  data: [
    	    	    		  {
    	    	    		   ...
    	    	    		   showInLegend: true,
    	    	    		   dataPoints: [
    	    	    		       <c:forEach var="opSys" items="${opSysMap}">
    	    	    		       {  y: ${opSys.value}, legendText:"${opSys.key} ${100*(opSys.value)}%", indexLabel: "${opSys.key} ${100*(opSys.value)}%" },
    	    	    		       </c:forEach>
    	    	    		  ]
    	    	    		 }
    	    	    		 ]
