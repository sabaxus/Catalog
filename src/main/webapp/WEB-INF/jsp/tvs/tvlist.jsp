				...
				<div class="filter">
					...
					<li class="Filtru">
						...
						<div class="col-sm-12">
							...
							<div>
								<form:checkboxes path="tipList" items="${tipList}"
									element="label class='checkbox'" />
								<br /> <br />
								<form:errors path="tipList" class="control-label" />
							</div>
						</div>

						<div class="col-sm-12">
							<label class="control-label">Tip ecran</label>
							<div>
								<form:checkboxes path="tipEcranList" items="${tipEcranList}"
									element="label class='checkbox'" />
								<br /> <br />
								<form:errors path="tipEcranList" class="control-label" />
							</div>
						</div>
						...
						<div class="col-sm-12">
							<label class="control-label">Sistem de operare</label>
							<div>
								<form:checkboxes path="sistemDeOperareList"
									items="${sistemDeOperareList}" element="label class='checkbox'" />
								<br /> <br />
								<form:errors path="sistemDeOperareList" class="control-label" />
							</div>
						</div>
							...
							<div class="col-sm-9">
								...
								<div class="Produs-listCenterColumn">
									<h3 class="Produs-nameHeading">
										<strong> <c:out value="${t.specificatii}" /></strong>
									</h3>
