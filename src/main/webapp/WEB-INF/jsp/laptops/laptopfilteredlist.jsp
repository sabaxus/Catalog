...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="container-fluid">
		...
		<div class="main">
			...
			<c:forEach var="l" items="${model.laptopList}" varStatus="theCount">
				...
				<div class="col-sm-9">
					...
					<div class="Produs-listCenterColumn">
						...
						<!-- Modal -->
						<div class="modal fade" id="myModal${theCount.count}"
							role="dialog">
			...
			<br /> <br /> <a
				href='${pageContext.request.contextPath}/laptops/newlist.htm'><button
					type="button" class="btn-info">Filter again the laptop
					list</button></a><br /> <br />
			<sec:authorize access="hasRole('ADMIN')">
				<div class="newlaptop">
					<a href='${pageContext.request.contextPath}/laptops/new.htm'><button
							type="button" class="btn-success">Add new laptop</button></a> <br />
					<br />
				</div>
			</sec:authorize>
