...
<script type="text/javascript">
  window.onload = function () {
    ...
    {
      title:{
        text: "Laptop Brands percentages",
        fontFamily: "Impact",
        fontWeight: "normal"
      },
	...
	{
	  title:{
	    text: "Laptop Screen Resolution percentages",
	    fontFamily: "Impact",
	    fontWeight: "normal"
	  },
    ...
    {
      title:{
        text: "Laptop Screen Dimensions percentages",
    	fontFamily: "Impact",
    	fontWeight: "normal"
      },
      ...
      data: [
      {
       ...
       dataPoints: [
    	   ...
    	   {  y: ${dimEcran.value}, legendText:"${dimEcran.key} ${100*(dimEcran.value)}%", indexLabel: "${dimEcran.key} ${100*(dimEcran.value)}%" },
    		...
    		{
    		  title:{
    		    text: "Laptop Processor Type percentages",
    		    fontFamily: "Impact",
    		    fontWeight: "normal"
    		  },
    		...
    		var chart4 = new CanvasJS.Chart("chartContainer4",
    	    		{
    	    		  title:{
    	    		    text: "Laptop Processor Frecvency percentages",
    	    		    fontFamily: "Impact",
    	    		    fontWeight: "normal"
    	    		  },
    	    		  ...
    	    		  data: [
    	    		  {
    	    		   ...
    	    		   showInLegend: true,
    	    		   dataPoints: [
    	    		       <c:forEach var="frecventaProcesor" items="${frecventaProcesorMap}">
    	    		       {  y: ${frecventaProcesor.value}, legendText:"${frecventaProcesor.key} ${100*(frecventaProcesor.value)}%", indexLabel: "${frecventaProcesor.key} ${100*(frecventaProcesor.value)}%" },
    	    		       </c:forEach>
    	    		  ]
    	    		 }
    	    		 ]
    	    		...
    	    		var chart5 = new CanvasJS.Chart("chartContainer5",
    	    	    		{
    	    	    		  title:{
    	    	    		    text: "Laptop RAM Memory Capacity percentages",
    	    	    		    fontFamily: "Impact",
    	    	    		    fontWeight: "normal"
    	    	    		  },
    	    	    		  ...
    	    	    		  data: [
    	    	    		  {
    	    	    		   ...
    	    	    		   showInLegend: true,
    	    	    		   dataPoints: [
    	    	    		       <c:forEach var="capacitateRAM" items="${capacitateRAMMap}">
    	    	    		       {  y: ${capacitateRAM.value}, legendText:"${capacitateRAM.key} ${100*(capacitateRAM.value)}%", indexLabel: "${capacitateRAM.key} ${100*(capacitateRAM.value)}%" },
    	    	    		       </c:forEach>
    	    	    		  ]
    	    	    		 }
    	    	    		 ]
    	    	    		...
    	    	    		var chart6 = new CanvasJS.Chart("chartContainer6",
    	    	    	    		{
    	    	    	    		  title:{
    	    	    	    		    text: "Laptop Colour percentages",
    	    	    	    		    fontFamily: "Impact",
    	    	    	    		    fontWeight: "normal"
    	    	    	    		  },
