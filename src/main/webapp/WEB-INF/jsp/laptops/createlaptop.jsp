...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<br />
	<div class="link"><a href="${pageContext.request.contextPath}/laptops/newlist.htm"><button type="button" class="btn btn-info btn-lg">Back to the list</button></a></div>
	<br/>

	<div class="title" align="center">
		<h2>Insert new laptop data</h2>
	</div>

	<form:form action="savenew.htm" method="post" commandName="newlaptopForm">
				...
				<div class="Specs-column">
					...
					<table class="Specs-table" border="1">
						...
						<tr class="Specs-row">
							...
							<td><form:errors path="nume" cssStyle="color: #ff0000;" /></td>
						</tr>
						<tr class="Specs-row">
				...
				<div class="Specs-column">
					...
					<table class="Specs-table" border="1">
						...
						<tr class="Specs-row">
							...
							<td class="Specs-cell"><form:errors
									path="bitiSistemOperare" cssStyle="color: #ff0000;" /></td>
						</tr>
						<tr class="Specs-row">
							<td class="Specs-cell">Altele:</td>
				...
				<div class="Specs-column">
					...
					<table class="Specs-table" border="1">
						...
						<tr class="Specs-row">
							...
							<td class="Specs-cell"><form:errors
									path="tastaturaNumerica" cssStyle="color: #ff0000;" /></td>
						</tr>
						<tr class="Specs-row">
				...
				<div class="Specs-column">
					...
					<table class="Specs-table" border="1">
						<tr class="Specs-row">
							...
							<td class="Specs-cell"><form:errors
									path="dimensiuniLxAxIcm" cssStyle="color: #ff0000;" /></td>
						</tr>
						<tr class="Specs-row">
		...
		<br/>
                    ...
                    <div class="container" align="center"><input type="submit" class="btn btn-info btn-lg" value="Save"></div>
